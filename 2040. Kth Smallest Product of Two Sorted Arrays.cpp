...
public:
    long long findCountSmallest(vector<int>& nums1, vector<int>& nums2,
        ...
        for (int i = 0; i < nums1.size(); i++) {
            ...
            if (nums1[i] >= 0) {
                int l = 0;
                int r = n - 1;
                int m = -1; // invaid index on the left hand side
                ...
                // smaller products and left hand side will contain larger
                // products
                int l = 0;
                int r = n - 1;
                int m = n;
    ...
    long long kthSmallestProduct(vector<int>& nums1, vector<int>& nums2,
        ...
        long long l = -1e10; // minimum product possible
        long long r = 1e10;  // maximum prodcut possible
